...
import com.wwx.study.tools.BaseTools;
...
public class LoginView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        final View view = LayoutInflater.from(context).inflate(R.layout.activity_login_layout, null);
...
//		});
    ...
    @OnClick({R.id.weixinLogin, R.id.qqLogin, R.id.weiboLogin})
    public void onClick(View view) {
        switch (view.getId()) {
//            boolean isauth;
            case R.id.weixinLogin:
//                isauth  = UMShareAPI.get(getContext()).isAuthorize(, platforms.get(0).mPlatform);
//                if (isauth) {
//                    UMShareAPI.get(getContext()).deleteOauth(mActivity, platforms.get(0).mPlatform, authListener);
//                } else {
//                    UMShareAPI.get(getContext()).doOauthVerify(mActivity, platforms.get(0).mPlatform, authListener);
//                }
                break;
            case R.id.qqLogin:
                break;
